...
<select name="target_format" id="target" required style="padding: 5px; border-radius: 4px;">
    
    <optgroup label="Video Phổ Biến">
        <option value="mp4" selected>MP4 (H.264 - Tương thích tốt nhất)</option>
        <option value="mkv">MKV (Matroska - Chất lượng cao)</option>
        <option value="avi">AVI (Định dạng cũ)</option>
    </optgroup>

    <optgroup label="Web & Thiết bị khác">
        <option value="webm">WEBM (Dành cho Web/Youtube)</option>
        <option value="mov">MOV (Dành cho MacOS/iPhone)</option>
        <option value="wmv">WMV (Windows Media Video)</option>
        <option value="flv">FLV (Flash Video cũ)</option>
    </optgroup>
